...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/Board.ts":[function(require,module,exports) {
"use strict";
    ...
    for (var row = 0; row < 4; row++) {
      ...
      for (var col = 0; col < 3; col++) {
        var cell = new Cell({
          row: row,
          col: col
        }, null); //cells와 element에 같이 넣어줘야된다.
...
exports.Game = void 0; //export 내보내질 때 지정된 이름으로 내보내짐 
...
new Game_1.Game();
},{"bootstrap/dist/css/bootstrap.css":"node_modules/bootstrap/dist/css/bootstrap.css","./styles/style.css":"src/styles/style.css","./Game":"src/Game.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
